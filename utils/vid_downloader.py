...
ld_window=tk.Tk()
ld_window.title("Facebook Video Downloader @avijit")
...
Status = tk.Label(ld_window, text="Facebook Video Downloader By Avijit!! :D", fg="blue", font=("Calibri", 9), bd=1, relief=tk.SUNKEN, anchor=tk.W, padx=3)
